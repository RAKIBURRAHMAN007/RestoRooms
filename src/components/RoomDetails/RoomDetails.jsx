...
const RoomDetails = () => {
    ...
    const { _id, room_id, name, description, price, image, capacity, type, features, reviewCount, availability } = roomData;
    console.log(room_id);
    ...
    const handleConfirmBooking = () => {
        ...
        const bookingData = {
            ...
            name, description, room_id, price, image, capacity, type, features, reviewCount, availability: false
        }
        ...
        <div className="bg-gray-900 border border-[#d3a955] text-white mt-10 w-11/12 mx-auto p-6 sm:p-12 md:p-16 lg:p-20">
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="flex flex-col justify-between">
                    ...
                    <p className="text-xl font-semibold mb-4">Price: <span className="text-green-400">${price}</span></p>
                    <p className="text-lg mb-4"><strong>Capacity:</strong> {capacity} people</p>
                    <p className="text-lg mb-4"><strong>Type:</strong> {type}</p>
                    ...
                    <p className="text-lg mb-4"><strong>Reviews:</strong> {reviewCount} reviews</p>
                    <p className="text-lg mb-4"><strong>Availability:</strong> {availabilityy ? "Available" : "Not Available"}</p>
                    ...
                    <button
                        ...
                        className={`border ${availabilityy === false ? 'bg-gray-400 text-gray-600 cursor-not-allowed' : 'bg-[#d3a955] text-white'} font-semibold py-2 px-6 rounded-lg mt-6 transition duration-300 ease-in-out transform hover:scale-105`}
                    ...
                    {reviews.length > 0 ? (
                        reviews.map((review, index) => (
                            <div key={index} className="border-b border-gray-500 pb-4">
                                <p className="text-lg font-semibold">Name : {review.username}</p>
            ...
            {isModalOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
                    <div className="bg-white text-black p-6 rounded-lg w-11/12 sm:w-9/12 md:w-7/12 lg:w-5/12">
                        ...
                        <div className="mb-4">
                            <label htmlFor="booking-date" className="block text-lg font-semibold mb-2">Select Booking Date:</label>
                            <DatePicker
