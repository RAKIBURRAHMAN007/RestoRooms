...
const MyBookingTable = ({ bookedRoom, setBookedRooms }) => {
    const { _id, room_id, name, description,reviewCount, price, image, type, bookingDate } = bookedRoom;
            ...
            <tr>
                ...
                <th className="flex flex-col gap-2">
                    <button
                        ...
                        className={`text-[#d3a955] border border-[#d3a955] btn-xs ${!isCancelable ? "cursor-not-allowed opacity-50" : ""
                            }`}
